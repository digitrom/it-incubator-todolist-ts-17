import { todolistsAPI, TodolistType, updateTodolistArg } from "./todolistsApi"
...
export const changeTodolistTitle = createAppAsyncThunk<updateTodolistArg, updateTodolistArg>(
